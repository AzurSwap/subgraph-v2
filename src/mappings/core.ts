...
import { updatePairDayData, updateTokenDayData, updateAzurswapDayData, updatePairHourData } from './dayUpdates'
...
export function handleTransfer(event: Transfer): void {
  ...
  let factory = AzurswapFactory.load(FACTORY_ADDRESS)
...
export function handleSync(event: Sync): void {
  ...
  let azurswap = AzurswapFactory.load(FACTORY_ADDRESS)

  // reset factory liquidity by subtracting onluy tarcked liquidity
  azurswap.totalLiquidityETH = azurswap.totalLiquidityETH.minus(pair.trackedReserveETH as BigDecimal)
  ...
  azurswap.totalLiquidityETH = azurswap.totalLiquidityETH.plus(trackedLiquidityETH)
  azurswap.totalLiquidityUSD = azurswap.totalLiquidityETH.times(bundle.ethPrice)
...
export function handleMint(event: Mint): void {
  ...
  azurswap.txCount = azurswap.txCount.plus(ONE_BI)
  ...
  let udd = updateAzurswapDayData(azurswap as AzurswapFactory, event)
...
export function handleSwap(event: Swap): void {
  ...
  let azurswap = AzurswapFactory.load(FACTORY_ADDRESS)
  azurswap.totalVolumeUSD = azurswap.totalVolumeUSD.plus(trackedAmountUSD)
  azurswap.totalVolumeETH = azurswap.totalVolumeETH.plus(trackedAmountETH)
  azurswap.untrackedVolumeUSD = azurswap.untrackedVolumeUSD.plus(derivedAmountUSD)
  azurswap.txCount = azurswap.txCount.plus(ONE_BI)
  ...
  let azurswapDayData = updateAzurswapDayData(azurswap as AzurswapFactory, event)
  ...
  azurswapDayData.dailyVolumeUSD = azurswapDayData.dailyVolumeUSD.plus(trackedAmountUSD)
  azurswapDayData.dailyVolumeETH = azurswapDayData.dailyVolumeETH.plus(trackedAmountETH)
  azurswapDayData.dailyVolumeUntracked = azurswapDayData.dailyVolumeUntracked.plus(derivedAmountUSD)
  azurswapDayData.save()
