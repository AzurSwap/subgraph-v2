...
export class AzurswapFactory extends Entity {
  ...
  save(): void {
    let id = this.get("id");
    assert(id !== null, "Cannot save AzurswapFactory entity without an ID");
    assert(
      id.kind == ValueKind.STRING,
      "Cannot save AzurswapFactory entity with non-string ID. " +
        'Considering using .toHex() to convert the "id" to a string.'
    );
    store.set("AzurswapFactory", id.toString(), this);
  }

  static load(id: string): AzurswapFactory | null {
    return store.get("AzurswapFactory", id) as AzurswapFactory | null;
  }
...
export class AzurswapDayData extends Entity {
  constructor(id: string) {
    super();
    this.set("id", Value.fromString(id));
  }
  ...
  save(): void {
    let id = this.get("id");
    assert(id !== null, "Cannot save AzurswapDayData entity without an ID");
    assert(
      id.kind == ValueKind.STRING,
      "Cannot save AzurswapDayData entity with non-string ID. " +
        'Considering using .toHex() to convert the "id" to a string.'
    );
    store.set("AzurswapDayData", id.toString(), this);
  }

  static load(id: string): AzurswapDayData | null {
    return store.get("AzurswapDayData", id) as AzurswapDayData | null;
  }
